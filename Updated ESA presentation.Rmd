...
- Detrimental effects of young parenthood: What do we know?
    ...
    - Focus has largely been on educational and labourmarket outcomes.
<br><br>
...
<img style="float: center;" src="images/pte_avgs.jpeg" title = "ate_dist" width="600" height="350">
...
3. SES background: Mothers year of schooling, 77%
...
- We can not find evidence of heterogeneity in the effects of early motherhood on later mental wellbeing
    ...
    - using 148 covariates from childhood and adolescence

- Instead we see a very small negative effect
...
- We see promises for BART in buidling theory on what impacts later life outcomes, as we do not have to pre-define which vairables are of importance.
